...
import { configureOfficeLayout, type AgentRosterEntry } from '../scene/layout/officeLayout'
...
export function OfficeCanvas({ entries }: { entries: AgentRosterEntry[] }): JSX.Element {
